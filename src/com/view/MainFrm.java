...
public class MainFrm extends JFrame {
	...
	public MainFrm() {
		...
		mntmNewMenuItem_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BookAppInterFrm bookTypeAddInterFrm = new BookAppInterFrm();
				bookTypeAddInterFrm.setVisible(true);
				table.add(bookTypeAddInterFrm);
			}
		});
		...
		JMenuItem mntmNewMenuItem = new JMenuItem("关于Disney");
		mntmNewMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DisneyInterFrm disneyInterFrm = new DisneyInterFrm();
				disneyInterFrm.setVisible(true);
				table.add(disneyInterFrm);				
			}
		});
